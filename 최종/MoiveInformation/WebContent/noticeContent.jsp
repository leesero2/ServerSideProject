    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form method="post" action="noticePro.jsp"><!--------------------------------------------------------------------------------------------------------------------->
                ...
                <table class="table table-striped"
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td style=" text-align:center; width: 149px;"><%=article.getNoticeNumber()%></td>
                            
                             <th style=" text-align:center; width: 149px;">작성자</th>
                            <td style=" text-align:center; width: 149px;">관 리 자 </td> 
                            
                            <th style=" text-align:center; width: 149px;"></th>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><%=article.getNoticeTitle()%></td>
                            <th style=" text-align:center; ">시간</th>
                            <td style=" text-align:center; "><%= sdf.format(article.getNoticeTime())%></td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="6" style="height: 500px; width: 1400px; margin: auto; background-color: #ffffff;"> <%=article.getNoticeContent()%></td>
               ...
               <tr>
                  <td colspan="4"></td>
                  <td colspan="2"><input type="button" value="글 목록" style="padding: 5px; margin-right: -4px;margin-left: 150px;"  onclick="document.location.href='notice.jsp?&pageNum=<%=pageNum%>'">
                  </td>
               </tr>
                </table>
