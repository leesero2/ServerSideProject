...
String pageNum = request.getParameter("pageNum");
  ...
  try{
      ...
      FreeDataBean article =  dbPro.updateGetArticle(num);
        ...
        <div class="slider">
           <div class="swiper-container">
            ...
            <h3 id="movie-text">자유게시판</h3>                        
               ...
               <div class="moviebar"> 
                <form method="post" action="FreeUpdatePro.jsp?pageNum=<%=pageNum %>" onsubmit="return writeSave()">
                ...
                <table class="table table-striped"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            maxlength="200" style="height: 40px; ime-mode:active; width: 1400px; margin: auto;" ><%=article.getFreeTitle()%></textarea></td>
                              ...
                              <td style="background-color: #DAD9FF; text-align: left; margin-left: 20px;"><p style="margin-left: 30px;">작성자 아이디</p>
                               ...
                               value="<%=article.getWriter()%>">
  									<input type="hidden" name="freeNumber" value="<%=article.getFreeNumber()%>"></td>
                                </tr>

                                <tr>

                            <td><textarea class="form-control" placeholder="내 용" name="freeContent" maxlength="2048" align="center"    style="height: 500px; margin: auto; width: 1400px; margin: auto;" ><%=article.getFreeContent()%></textarea></td>
