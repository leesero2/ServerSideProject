...
<<header id="header">
        ...
        <div class="slider">
           <div class="swiper-container">
            ...
            <h3 id="movie-text">리뷰 게시판</h3>                        
               ...
               <div class="moviebar"> 
                <form method="post" action="ReviewPro.jsp">
                ...
                <table class="table table-striped"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><textarea type="text" class="form-control"  placeholder="영화 제목" name="reviewMovieTitle" 
                            maxlength="200" style="height: 40px; width: 1400px; margin: auto;"></textarea></td>

                                </tr>
                                 <tr>

                              <td style="background-color: #DAD9FF; text-align: left; margin-left: 20px;"><p style="margin-left: 30px;">작성자 아이디</p> <input type="text"  placeholder="작성자" name="writer" style="height: 15px; width: 1400px; font-size: 15px; background-color: #DAD9FF; border:none;border-right:0px; border-top:0px; boder-left:0px; margin-left: 30px; boder-bottom:0px;"
 ...
 value="<%=id%>" ></td>
                            ...
                            <td><textarea class="form-control" placeholder="내 용" name="reviewContent" maxlength="2048" align="center"    style="height: 500px; margin: auto; width: 1400px; margin: auto;"></textarea></td>
