...
<<header id="header">
        ...
        <div class="slider">
           <div class="swiper-container">
            ...
            <h3 id="movie-text">자유게시판</h3>                        
               ...
               <div class="moviebar"> 
                <form method="post" action="FreePro.jsp">
                ...
                <table class="table table-striped"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><textarea type="text" class="form-control"  placeholder="글 제목" name="freeTitle" 
 ...
 value="<%=id%>" ></td>
                            ...
                            <td><textarea class="form-control" placeholder="내 용" name="freeContent" maxlength="2048" align="center"    style="height: 500px; margin: auto; width: 1400px; margin: auto;"></textarea></td>
