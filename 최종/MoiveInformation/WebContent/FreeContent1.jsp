...
try{
	...
	FreeDataBean article = dbPro.getArticle(num);
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form method="post" action="noticePro.jsp"><!--------------------------------------------------------------------------------------------------------------------->
                ...
                <table class="table table-striped"
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td style=" text-align:center; width: 149px;"><%=article.getFreeNumber()%></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><%=article.getFreeTitle()%></td>
                            <th style=" text-align:center; ">시간</th>
                            <td style=" text-align:center; "><%= sdf.format(article.getFreeTime())%></td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="6" style="height: 500px; width: 1400px; margin: auto; background-color: #ffffff;"> <%=article.getFreeContent()%></td>
               ...
               <tr>
                  <td colspan="4"></td>
                  <td colspan="2"><input type="button" value="글 목록" style="padding: 5px; margin-right: -4px;margin-left: 150px;"  onclick="document.location.href='FreeWrite.jsp?&pageNum=<%=pageNum%>'">
                  <input type="button" value="글 수정" style="padding: 5px;"onclick="document.location.href='FreeUpdateForm.jsp?num=<%=article.getFreeNumber()%>&pageNum=<%=pageNum%>'">
                  <input type="button" value="글 삭제" style="padding: 5px; margin-left: -4px;" onclick="document.location.href='DeleteForm.jsp?num=<%=article.getFreeNumber()%>&pageNum=<%=pageNum%>'"></td>
               </tr>
                </table>
