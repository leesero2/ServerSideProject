 ...
 <!--   <p>Resize the browser window to see the effect.</p> -->
  ...
  <table class="table table-bordered" margin="10px">
   ...
   for(int i=0; i<articleList.size(); i++){
	   FreeDataBean article = articleList.get(i);
	   
	   %>
     	<tr>
 	<td align="center"  width="70" ><%=number--%></td>      
      <td width="400">
      <a href="FreeContent1.jsp?num=<%=article.getFreeNumber()%>&pageNum=<%=currentPage%>">
          <%=article.getFreeTitle() %> </a> 
      </td>
      
       <td width="100"><%=article.getWriter() %></td>
      <td align="center"  width="100" ><%=sdf.format(article.getFreeTime())%></td> 
  ...
  <%} %>  
       ...
       <a href = "FreeWriteForm.jsp" class="btn btn-primary pull-right"  style= "margin-left: 93%;">글작성</a> 
    <% 
if(count>0) {
