                ...
                <table class="table table-striped"
                    ...
                    <thead>
                        ...
                        <tr>
                           ...
                           <td rowspan="6"> <img src="moviePhoto/<%=article.getMoviePoster()%>" border="0" style="height: 400px;width: 300px;"></td> 

                            <td colspan="3" style ="font-size:20px; font-weight:bold; ">제 목 : <%=article.getMovieTitle()%></td>

                        </tr>
                  <tr>
                   <td colspan="3">개 봉 일 : <%=article.getMovieOpen()%></td>
                  </tr>
                  
                  <tr>
                   <td colspan="3">감 독 : <%=article.getMovieDirector()%></td>
                  </tr>
                  
                  <tr>
                   <td><img src="moviePhoto/<%=article.getMovieActorPhoto1()%>" border="0"></td>
                   <td><img src="moviePhoto/<%=article.getMovieActorPhoto2()%>" border="0"></td>
                   <td><img src="moviePhoto/<%=article.getMovieActorPhoto3()%>" border="0"></td>
                  </tr>
                  
                  <tr style="text-align: center;">
                   <td><%=article.getMovieActor1() %></td>
                   <td><%=article.getMovieActor2() %></td>
                   <td><%=article.getMovieActor3() %></td>
                  </tr>
                  
                  <tr>
                   <td colspan="3" >평 점 : 10/<%=article.getMovieScore() %></td>
                  </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td colspan="4" style="text-align: center;">줄거리</td>
                        </tr>
                       
                        <tr>
                     
                            <td colspan="4" style="height: 500px; width: 1400px; margin: auto; font-size:20px;
                            background-color: #ffffff ;"><%=article.getMovieStory()%></td>
