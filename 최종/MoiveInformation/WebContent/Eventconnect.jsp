...
<body>
   ...
   <div class="row5">
		<img src="eventPhoto/ee1.jpeg" alt="첫 이벤트" style=" margin-bottom: 40px; height: 1200px; width: 400px;">
   </div>
        ...
        <div id="footer_sns">
            <div class="container">
                <div class="footer_sns">
                    <ul>
                        <li class="icon s1"><a href="https://www.twitter.com/"><span class="ir_pm">트위터</span></a></li>
                        <li class="icon s2"><a href="https://www.fackbook.com/"><span class="ir_pm">페이스북</span></a></li>
                        <li class="icon s3"><a href="https://www.instagram.com/"><span class="ir_pm">인스타그램</span></a></li>
