...
<header id="header">
    ...
    <div class="container">
        ...
        <div class="row" style="margin-left:20%;margin-top: 10%;">
            ...
            <form method="POST" name="delForm" action="ReviewDeletePro.jsp?pageNum=<%=pageNum%>" onsubmit="return deleteSave()"> 
 <table>
  <tr height="30">
 ...
 <!--  align=center-->
                    ...
                    <tbody width = "20">
                        ...
                        <tr>
                            <tr height="30" class="form-control" name="reviewContent" maxlength="2048" margin=" auto;" style="height: 53.979166px;">
    ...
    <td align=center>
      <button type="submit" class="btn btn-primary pull-right" onclick="javascript:btn()" value="글삭제" style="margin-left: 20px;">글삭제</button>
       <button type="button" class="btn btn-primary pull-right" onclick="document.location.href='Review.jsp?pageNum=<%=pageNum%>'onclick="javascript:btn()" value="글삭제">글목록</button>    
   </td>
