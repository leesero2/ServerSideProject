...
<%@ page import = "notice.BoardDBBean" %>
...
<% }  else  { %>  
  ...
  <table class="table table-bordered">
      ...
      <tr>
        <th  width="70" bgcolor="#8181F7"><b>번  호</b></th>
      	 <th align="center">제 목</th>
        <!-- <th  align="center"><b>내 용</b></th> -->
        <th  align="center"><b>작 성 일</b></th>
      </tr>
      <%   	
   for(int i=0; i<articleList.size(); i++){
 	...
 	<td align="center"  width="70" ><%=number--%></td>      
      <td width="400">
      <a href="noticeContent.jsp?num=<%=article.getNoticeNumber()%>&pageNum=<%=currentPage%>">
          <%=article.getNoticeTitle() %> </a> 
      </td></td>
       <%-- <td width="100"><%=article.getNoticeContent() %></td> --%>
      <td align="center"  width="100" ><%=sdf.format(article.getNoticeTime())%></td> 
   ...
   <!--  <tbody>
      <tr>
        ...
        <td style="text-align:center;">시스템 점검안내(07/01)</td>
        <td>안녕하십니까, 이지훈관리자입니다.<br> 시스템 점검으로인해  07/01에 일부 서비스 사용 제한이 있을 수 있으므로 참고해주시길바랍니다.</td>
...
if(count>0) {
	...
	<% for (int i = startPage; i<= endPage; i++){ %> 
	 <!-- 여기가 핵심부분 -->
	<a class="select" href="notice.jsp?pageNum=<%= i%>">[<%=i %>]</a>
	...
	%>   
     ...
     <!--  <a href = "ReviewForm.jsp" class="btn btn-primary pull-right" style= "margin-left: 93%;">글작성</a>  -->
